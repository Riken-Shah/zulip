...
async function test_change_password(page: Page): Promise<void> {
    ...
    // For some strange reason #change_password_modal:focus is not working here with Firefox.
...
async function test_get_api_key(page: Page): Promise<void> {
    ...
    // You can see the screenshot of it here https://github.com/zulip/zulip/pull/17136.
